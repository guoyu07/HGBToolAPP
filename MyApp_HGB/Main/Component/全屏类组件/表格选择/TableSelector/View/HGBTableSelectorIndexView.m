...
@end
@implementation HGBTableSelectorIndexView
...
+ (instancetype)viewWithFrame:(CGRect)frame indexTitles:(NSArray *)indexTitles tableView:(UITableView *)tableView tableViewSectionsCount:(NSInteger)sectionsCount{
    HGBTableSelectorIndexView *indexView = [[HGBTableSelectorIndexView alloc] initWithFrame:frame indexTitles:indexTitles tableView:tableView tableViewSectionsCount:sectionsCount];
    return indexView;
}

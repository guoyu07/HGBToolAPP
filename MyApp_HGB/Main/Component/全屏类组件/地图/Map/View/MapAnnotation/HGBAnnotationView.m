...
@implementation HGBAnnotationView
...
- (id)initWithAnnotation:(id<MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        messageImageView.image=[UIImage imageNamed:@"HGBMapBundle.bundle/bg_label1"];
        messageImageView.alpha=0.94;
        [self.promtView addSubview:messageImageView];
        self.titleLab=[[HGBMapActionLabel  alloc]initWithFrame:CGRectMake(26*wScale,28*hScale, w-64*wScale, 26*hScale)];
        ...
        UIImageView *imageV=[[UIImageView alloc]initWithFrame:CGRectMake((w-38*wScale)*0.5, h_t, w_l, h_l)];
         UIImage *myImage = [UIImage imageNamed:@"HGBMapBundle.bundle/icon_zuobiao"];

...
@interface HGBMapBottomSheet ()
/**
 父控制器
 */
@property (strong,nonatomic)UIViewController *parent;
@property(strong,nonatomic)id<HGBMapBottomSheetDelegate>delegate;
/**
 根控制器
 */
...
@implementation HGBMapBottomSheet
static HGBMapBottomSheet *obj=nil;
#pragma mark init
...
-(instancetype)initWithDelegate:(id<HGBMapBottomSheetDelegate>)delegate InParent:(UIViewController *)parent
{
    self=[super init];
    if(self){
...
-(void)viewSetUp{
    [self.tableView registerClass:[HGBMapBottomCell class] forCellReuseIdentifier:identify_bottomsheet];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HGBMapBottomCell *cell = [tableView dequeueReusableCellWithIdentifier:identify_bottomsheet forIndexPath:indexPath];

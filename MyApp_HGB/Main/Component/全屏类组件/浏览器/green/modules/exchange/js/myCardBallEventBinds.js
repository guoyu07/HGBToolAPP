				...
				//跳转积分兑换页面
	             onShops:function(dataid){
	             	...
	             	if(type != null && type!='' && type == '1'){
	             		...
	             		for(var i = 0 ; i < vue_modual.tenantsList.list.length ; i ++){
	             			if(vue_modual.tenantsList.list[i].id_ == dataid){
								conserve('tenantInformation',vue_modual.tenantsList.list[i]);
								$.router.load('../../modules/integralwallet/addShops_tpl.html',true);
	             			}
	             		}
	             	}else{
	             		$.router.load('./addShop_tpl.html?dataid='+dataid,true);
	             	}
...
//      vue_modual.tenantsList.list = [];
//               var obj = {};
//               obj.mobile_phone_ = '1111111';
//               obj.code_='1111111111';
//               obj.name_ ='1111111';
//        vue_modual.tenantsList.list.push(obj);
//               var obj = {};
//               obj.mobile_phone_ = '1111111';
//               obj.code_='1111111111';
//               obj.name_ ='123456';

...
/**
 扫码区域动画效果
 */
typedef enum HGBScanViewAnimationStyle
{
    HGBScanViewAnimationStyle_LineMove,   //线条上下移动
    HGBScanViewAnimationStyle_NetGrid,//网格
    HGBScanViewAnimationStyle_LineStill,//线条停止在扫码区域中央
    HGBScanViewAnimationStyle_None    //无动画
    
}HGBScanViewAnimationStyle;


/**
 扫码区域4个角位置类型
 */
typedef enum HGBScanViewPhotoframeAngleStyle
{
    HGBScanViewPhotoframeAngleStyle_Inner,//内嵌，一般不显示矩形框情况下
    HGBScanViewPhotoframeAngleStyle_Outer,//外嵌,包围在矩形框的4个角
    HGBScanViewPhotoframeAngleStyle_On   //在矩形框的4个角上，覆盖
}HGBScanViewPhotoframeAngleStyle;


/**
 扫描样式
 */
@interface HGBScanViewStyle : NSObject
#pragma mark -中心位置矩形框
/**
...
/**
 @brief  扫码区域的4个角类型
 */
@property (nonatomic, assign) HGBScanViewPhotoframeAngleStyle photoframeAngleStyle;
//扫码方向
...
/**
 @brief  扫码动画效果:线条或网格
 */
@property (nonatomic, assign) HGBScanViewAnimationStyle anmiationStyle;

...
/**
 cell表层按钮
 */
@protocol HGBBottomBaseCellBackGroundButtonDelegate <NSObject>
-(void)bottomBaseCellBackGroundButtonActionWithIndexPath:(NSIndexPath *)indexPath;
@end

@interface HGBBottomBaseTableViewCell : UITableViewCell
@property(strong,nonatomic)id<HGBBottomBaseCellBackGroundButtonDelegate>backGroundDelegate;

...
@implementation HGBKeybordTTAlgorithmSM4

+ (nullable instancetype)cbcSM4WithKey:(nonnull NSString *)secretKey iv:(nonnull NSString *)iv
{
    HGBKeybordTTAlgorithmSM4 *cbcSM4 = [[HGBKeybordTTAlgorithmSM4 alloc]initWithKey:secretKey iv:iv];
...
{
    HGBKeybordTTAlgorithmSM4 *ecbSM4 = [[HGBKeybordTTAlgorithmSM4 alloc]initWithKey:secretKey];
...
- (NSString *)decryptionWithSM4Key:(NSString *)secretKey iv:(NSString *)iv decryptionText:(NSString *)decryptiontext
{
    ...
    sm4_context ctx;
    hgbkeybordsm4_setkey_dec(&ctx, pKey);
    hgbkeybordsm4_crypt_cbc(&ctx,0,(int)msgLength,(unsigned char *)pIv,(unsigned char *)pMsg,(unsigned char *)pOutput);

    unsigned long stringLength = 0;
    hgbkeybordunpaddingForDecryption(&output, &stringLength);
...
- (NSString *)encryptionWithSM4Key:(NSString *)secretKey iv:(NSString *)iv encryptionText:(NSString *)encryptiontext
{
    ...
    hgbkeybordpaddingForEncryption(&pMsg, msgLength);
    unsigned char *pfreeMsg = pMsg;

    sm4_context ctx;
    hgbkeybordsm4_setkey_enc(&ctx, pKey);
    hgbkeybordsm4_crypt_cbc(&ctx,1,paddingLength,(unsigned char *)pIv,(unsigned char *)pMsg,(unsigned char *)output);
...
- (nullable NSString *)encryptionWithSM4Key:(nonnull NSString *)secretKey encryptionText:(nonnull NSString *)encryptiontext
{
    ...
    sm4_context ctx;
    hgbkeybordsm4_setkey_enc(&ctx, pKey);
    hgbkeybordsm4_crypt_ecb(&ctx,1,paddingLength,(unsigned char *)pMsg,(unsigned char *)output);
...
- (nullable NSString *)decryptionWithSM4Key:(nonnull NSString *)secretKey decryptionText:(nonnull NSString *)decryptiontext
{
    ...
    sm4_context ctx;
    hgbkeybordsm4_setkey_dec(&ctx, pKey);
    hgbkeybordsm4_crypt_ecb(&ctx,0,(int)msgLength,(unsigned char *)pMsg,(unsigned char *)output);

    unsigned long stringLength = 0;
    hgbkeybordunpaddingForDecryption(&pOutput, &stringLength);

...
@protocol HGBDropDownDelegate <NSObject>
 ...
 *  @return 返回NSUInteger
 */
- (NSUInteger)numberOfRowsToDisplayIndropDown:(HGBDropDown *)dropDown itemArrayCount:(NSUInteger)count;
...
@interface HGBDropDown : UIView

@property (nonatomic, weak) id<HGBDropDownDelegate> delegate;

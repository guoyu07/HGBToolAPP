...
@interface HGBImageView()
@property (nonatomic, assign) id target;
@property (nonatomic, assign) SEL action;
@end
@implementation HGBImageView
...
{
    if(self.type==HGBImageViewTypeNOLimit||self.type== HGBImageViewTypeOnlyAction){
...
-(BOOL)canPerformAction:(SEL)action withSender:(id)sender{
    if(self.type==HGBImageViewTypeNOLimit||self.type==HGBImageViewTypeOnlyTool){
    ...
    }else if(self.type==HGBImageViewTypeOnlyCopyTool){

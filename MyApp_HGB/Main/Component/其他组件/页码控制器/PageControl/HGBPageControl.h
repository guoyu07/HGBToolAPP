...
/**
 自定义页码控制器
 */
typedef NS_ENUM(NSUInteger, HGBPageControlAlignment) {
    HGBPageControlAlignmentLeft = 1,
    HGBPageControlAlignmentCenter,
    HGBPageControlAlignmentRight
};

typedef NS_ENUM(NSUInteger, HGBPageControlVerticalAlignment) {
    HGBPageControlVerticalAlignmentTop = 1,
    HGBPageControlVerticalAlignmentMiddle,
    HGBPageControlVerticalAlignmentBottom
};

typedef NS_ENUM(NSUInteger, HGBPageControlTapBehavior) {
    HGBPageControlTapBehaviorStep	= 1,
    HGBPageControlTapBehaviorJump
};

@interface HGBPageControl : UIControl
...
@property (nonatomic) HGBPageControlAlignment alignment					UI_APPEARANCE_SELECTOR; // deafult is Center
@property (nonatomic) HGBPageControlVerticalAlignment verticalAlignment	UI_APPEARANCE_SELECTOR;	// deafult is Middle
...
@property (nonatomic) HGBPageControlTapBehavior tapBehavior;	// SMPageControlTapBehaviorStep provides an increment/decrement behavior exactly like UIPageControl. SMPageControlTapBehaviorJump allows specific pages to be selected by tapping their respective indicator. Default is SMPageControlTapBehaviorStep

...
@interface HGBMediaImageView()
@property (nonatomic, assign) id target;
@property (nonatomic, assign) SEL action;
@end
@implementation HGBMediaImageView
...
{
    if(self.type==HGBMediaImageViewTypeNOLimit||self.type== HGBMediaImageViewTypeOnlyAction){
...
-(BOOL)canPerformAction:(SEL)action withSender:(id)sender{
    if(self.type==HGBMediaImageViewTypeNOLimit||self.type==HGBMediaImageViewTypeOnlyTool){
    ...
    }else if(self.type==HGBMediaImageViewTypeOnlyCopyTool){

...
@interface HGBOUTViewController ()
/**
 数据源
 */
...
@implementation HGBOUTViewController
#pragma mark life
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"外部app打开文件工具":@[@"打开pdf",@"打开word"]};
    self.keys=@[@"外部app打开文件工具"];

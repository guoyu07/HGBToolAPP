...
@interface HGBHTMLtoPDFViewController ()
/**
 数据源
 */
...
@implementation HGBHTMLtoPDFViewController
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"HTML转PDF:":@[@"HTML转PDF"]};
    self.keys=@[@"HTML转PDF:"];

...
@interface HGBQuickLookViewController ()
/**
 数据源
 */
...
@implementation HGBQuickLookViewController
#pragma mark life
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"quick工具":@[@"打开pdf",@"打开word"]};
    self.keys=@[@"quick工具"];

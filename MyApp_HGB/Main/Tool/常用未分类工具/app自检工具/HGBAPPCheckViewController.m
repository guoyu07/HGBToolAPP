...
/**
 ...
 UIKit.framework
 */
@interface HGBAPPCheckViewController ()
/**
 数据源
 */
...
@implementation HGBAPPCheckViewController
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"APP自检:自检app字符串请使用使用者自己配置":@[@"APP自检:"]};
    self.keys=@[@"APP自检:自检app字符串请使用使用者自己配置"];

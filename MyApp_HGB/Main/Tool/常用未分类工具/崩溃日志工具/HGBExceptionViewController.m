 ...
 */
@interface HGBExceptionViewController ()
/**
 数据源
 */
...
@implementation HGBExceptionViewController
#pragma mark life
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"APP崩溃收集请到Documents文件下查看":@[@"崩溃吧程序"]};
    self.keys=@[@"APP崩溃收集请到Documents文件下查看"];

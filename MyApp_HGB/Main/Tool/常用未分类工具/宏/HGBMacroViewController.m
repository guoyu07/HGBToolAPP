...
//#import "HGBMacroTool.h"
#import "HGBMacroConfig.h"

#import "HGBCommonSelectCell.h"
#define Identify_Cell @"cell"

@interface HGBMacroViewController ()
/**
 数据源
 */
...
@implementation HGBMacroViewController
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"宏:":@[@"常用宏1-打印",@"常用宏2-打印",@"常用宏3-弹窗"]};
    self.keys=@[@"宏:"];

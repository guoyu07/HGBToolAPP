...
-(void)viewSetUp{
    ...
    [self.tableView registerClass:[HTableViewCell class] forCellReuseIdentifier:Identify_Cell];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:Identify_Cell forIndexPath:indexPath];
    cell.label.text=nil;

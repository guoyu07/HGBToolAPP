...
@interface HGBPD5ViewController ()
/**
 数据源
 */
...
@implementation HGBPD5ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [self presentControllerWithNavgation:[[HGBPD6ViewController alloc]init]];

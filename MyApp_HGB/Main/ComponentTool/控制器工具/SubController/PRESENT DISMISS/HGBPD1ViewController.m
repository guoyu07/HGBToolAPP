...
@interface HGBPD1ViewController ()
/**
 数据源
 */
...
@implementation HGBPD1ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [self presentControllerWithNavgation:[[HGBPD2ViewController alloc]init]];

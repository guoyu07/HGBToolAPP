...
#import "HGBPD3ViewController.h"
#import "HGBCommonSelectCell.h"
#define Identify_Cell @"cell"

#import "HGBPD4ViewController.h"
#import "UIViewController+HGBUntil.h"
@interface HGBPD3ViewController ()
/**
 数据源
 */
...
@implementation HGBPD3ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [self presentControllerWithNavgation:[[HGBPD4ViewController alloc]init]];

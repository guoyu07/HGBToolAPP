...
@interface HGBPD2ViewController ()
/**
 数据源
 */
...
@implementation HGBPD2ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [self presentControllerWithNavgation:[[HGBPD3ViewController alloc]init]];

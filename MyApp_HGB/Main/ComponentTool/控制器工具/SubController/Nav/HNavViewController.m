...
@implementation HNavViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            ...
            [self presentController:[[HNav1ViewController alloc]init]];
        }else if (indexPath.row==1){
            [self presentController:[[HNav2ViewController alloc]init]];

...
@interface HGBPP4ViewController ()
/**
 数据源
 */
...
@implementation HGBPP4ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [[UIViewController currentViewController]pushController:[[HGBPP5ViewController alloc]init]];

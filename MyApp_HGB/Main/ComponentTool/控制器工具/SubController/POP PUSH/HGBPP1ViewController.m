...
@interface HGBPP1ViewController ()
/**
 数据源
 */
...
@implementation HGBPP1ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [[UIViewController currentViewController]pushController:[[HGBPP2ViewController alloc]init]];

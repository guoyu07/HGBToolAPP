...
#import "HGBPP2ViewController.h"
#import "HGBCommonSelectCell.h"
#define Identify_Cell @"cell"

#import "HGBPP3ViewController.h"
#import "UIViewController+HGBUntil.h"

@interface HGBPP2ViewController ()
/**
 数据源
 */
...
@implementation HGBPP2ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [[UIViewController currentViewController]pushController:[[HGBPP3ViewController alloc]init]];

...
#import "HGBPP4ViewController.h"
#import "UIViewController+HGBUntil.h"
@interface HGBPP3ViewController ()
/**
 数据源
 */
...
@implementation HGBPP3ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [[UIViewController currentViewController]pushController:[[HGBPP4ViewController alloc]init]];

//
//  HGBBaiduMapBottomBaseTableViewCell.m
//  测试
//
...
#import "HGBBaiduMapBottomBaseTableViewCell.h"
#import "HGBBaiduMapBottomPopHeader.h"

@interface HGBBaiduMapBottomBaseTableViewCell()
/**
 短底部分割线
 */
...
@implementation HGBBaiduMapBottomBaseTableViewCell
#pragma mark init
...
-(void)buttonActionHandle:(UIButton *)_b{
    ...
    if(self.backGroundDelegate&&[self.backGroundDelegate respondsToSelector:@selector(baiduBottomBaseCellBackGroundButtonActionWithIndexPath:)]){
        [self.backGroundDelegate baiduBottomBaseCellBackGroundButtonActionWithIndexPath:self.indexPath];
    }
}

...
#import "HGBBaiduMapBottomCell.h"
#import "HGBBaiduMapBottomPopHeader.h"

#define identify_bottomsheet @"bottomsheet"



@interface HGBBaiduMapBottomSheet ()
/**
 父控制器
 */
@property (strong,nonatomic)UIViewController *parent;
@property(strong,nonatomic)id<HGBBaiduMapBottomSheetDelegate>delegate;
/**
 根控制器
 */
...
@implementation HGBBaiduMapBottomSheet
static HGBBaiduMapBottomSheet *obj=nil;
#pragma mark init
...
-(instancetype)initWithDelegate:(id<HGBBaiduMapBottomSheetDelegate>)delegate InParent:(UIViewController *)parent
{
    self=[super init];
    if(self){
...
-(void)viewSetUp{
    [self.tableView registerClass:[HGBBaiduMapBottomCell class] forCellReuseIdentifier:identify_bottomsheet];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HGBBaiduMapBottomCell *cell = [tableView dequeueReusableCellWithIdentifier:identify_bottomsheet forIndexPath:indexPath];
